      ...
      <div class="item nav">
        <header class="header-nav">
          ...
          <div class="btn_menu">
            ...
            <div class="btn_logout"><a href=" https://rcsystemapp.azurewebsites.net/index.php"><img src="./img/logout-svgrepo-com.svg" alt="logout" title="Sair"></a></div>
          </div>
        </header>
      </div>
      <div class="item sidenav menu_lateral">
        <div class="menu_clientes"> <a href="https://rcsystemapp.azurewebsites.net/clientes.php" title="Clientes"><img src="./img/users-svgrepo-com.svg" alt="Clientes"></a></div>
        <div class="menu_servicos"> <a href=" https://rcsystemapp.azurewebsites.net/orcamento.php" title="Serviços"><img src="./img/tools-svgrepo-com.svg" alt="Serviços"></a></div>
        <div class="menu_agendamentos"> <a href=" https://rcsystemapp.azurewebsites.net/agendamento.php" title="Agendamentos"><img src="./img/calendar-svgrepo-com.svg" alt="Agendamentos"></a></div>
        <div class="menu_tecnicos"> <a href=" https://rcsystemapp.azurewebsites.net/tecnicos.php" title="Técnicos"><img src="./img/construction-worker-svgrepo-com.svg" alt="Técnicos"></a></div>
      </div>
                ...
                <tr id="cli-id-<?= $cod ?>">
                  ...
                  <td>
                    <div class="btn_crud btn_acoes">
                      ...
                      <button id="delete-<?= $cli->cod ?>" class="btn_crud btn_exclui" type="button" data-action="delete"></button>
                    </div>
                  </td>
                </tr>
              <?php } ?>
